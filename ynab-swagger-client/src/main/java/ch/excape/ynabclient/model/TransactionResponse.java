...
public class TransactionResponse {
  @JsonProperty("data")
  private TransactionDetailWrapper data = null;

  public TransactionResponse data(TransactionDetailWrapper data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public TransactionDetailWrapper getData() {
    return data;
  }

  public void setData(TransactionDetailWrapper data) {
    this.data = data;
  }
