...
public class TransactionsImportResponse {
  @JsonProperty("data")
  private TransactionImportResponseWrapper data = null;

  public TransactionsImportResponse data(TransactionImportResponseWrapper data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public TransactionImportResponseWrapper getData() {
    return data;
  }

  public void setData(TransactionImportResponseWrapper data) {
    this.data = data;
  }
