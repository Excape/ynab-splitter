...
public class CategoryGroupWithCategories extends CategoryGroup {
   ...
   * @return categories
  **/
  @Schema(required = true, description = "Category group categories.  Amounts (budgeted, activity, balance, etc.) are specific to the current budget month (UTC).")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.categories, categoryGroupWithCategories.categories) &&
        super.equals(o);
  }
